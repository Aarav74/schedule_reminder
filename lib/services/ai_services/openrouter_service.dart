...
class OpenRouterService implements AIServiceInterface {
  ...
  @override
  String getServiceName() => 'OpenRouter AI Service';

  @override
  AIProvider getProvider() => AIProvider.openrouter;
  ...
  ServiceCost getServiceCost() {
    final costPerToken = 0.0001;
    final totalTokens = _totalCalls * 1000;
    return ServiceCost(
  ...
  Map<String, dynamic> _buildTextRequest(
    ...
    return {
      ...
      'max_tokens': parameters?['maxTokens'] ?? _maxTokens,
    };
  }
      ...
      final response = await _dio.post(
        ...
        options: Options(
          headers: {
            ...
            'HTTP-Referer': 'https://github.com/Aarav74/schedule_reminder',
            'X-Title': 'Schedule Reminder App',
          },
        ),
      );
      return response;
